...
from train_vit.utils.dataloaders import *
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/lixudong39/notespace/nni-vit/data/ImageNet', type=str,
                        help='dataset path')
...
def main(args):
    ...
    data_loader_train, train_loader_len = get_train_loader(args, args.data, args.batch_size, workers=args.workers,
                                                      input_size=args.input_size)
    data_loader_val, val_loader_len = get_val_loader(args.data, args.batch_size, workers=args.workers,
                                                input_size=args.input_size)
    ...
    if args.eval:
        ...
        print(f"Accuracy of the network on the {val_loader_len} test images: {test_stats['acc1']:.1f}%")
        return
